...
const EXPERTISE_DATA = [
  {
    ...
    description: 'I guide the visual and creative vision of your projects, making sure everything looks and feels like you.',
    stat: '50+',
    statLabel: 'Projects',
  ...
  },
  {
    ...
    description: 'I help you tell your brand\'s story in a way that feels real and resonates with the right people.',
    stat: '5+',
    statLabel: 'Years',
  ...
  },
  {
    ...
    number: '03',
    title: 'Photography',
    description: 'I capture images that reflect your brand\'s personality, authentic, polished, and ready to use anywhere.',
    stat: '4',
    statLabel: 'Cities',
  ...
  },
  {
    ...
    description: 'From short-form clips to longer edits, I create video content that grabs attention and holds it.',
    stat: '20+',
  ...
  },
  {
    ...
    description: 'I develop a clear plan for your social channels, what to post, when, and why it matters.',
    stat: '30+',
    statLabel: 'Artists',
  ...
  },
  {
    ...
    description: 'I come up with creative ideas for campaigns that stand out and get people talking.',
    stat: '15+',
    statLabel: 'Campaigns',
  ...
  },
  {
    ...
    description: 'I produce the actual content, visuals, copy, whatever you need to show up consistently.',
    stat: '25+',
  ...
  },
  {
    ...
    description: 'I track what\'s emerging in culture and online, so you know what\'s worth paying attention to.',
    stat: '100%',
    statLabel: 'Passion',
  ...
  },
  {
    ...
    description: 'I help brands understand the cultural landscape and find their place in it, without feeling forced or out of touch.',
    stat: '10+',
    statLabel: 'Labels',
